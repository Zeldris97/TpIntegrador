            ...
            <table class="auto-style1">
                <tr>
                    <td class="auto-style19">
                        &nbsp;&nbsp;&nbsp;
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Administrador/AgregarPeliculas.aspx">Agregar peliculas</asp:HyperLink>
                    </td>
                    <td class="auto-style20">
                        <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/Administrador/MenuAdministrador.aspx">Menu</asp:HyperLink>
                    </td>
